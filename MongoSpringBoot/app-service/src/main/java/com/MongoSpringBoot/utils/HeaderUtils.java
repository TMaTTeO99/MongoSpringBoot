...
public class HeaderUtils {
    ...
    public static String convertHeader(Object data) {
        String kafkaEventTypeHeaderValue = "NON_MANAGED_TYPE";
    ...
    public static HttpHeaders createEntityCreationAlert(String entityName, String param) {
        return createEntityCreationAlert("Guideline service", true, entityName, param);
    }
